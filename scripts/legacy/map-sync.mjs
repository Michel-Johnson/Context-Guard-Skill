...
import { diffTrees, same, validate, MapError } from '../shared/map-model.mjs';
import { withFileLock, atomicWrite, readJSON, encode, pause } from '../shared/io.mjs';
import { syncPaths } from '../shared/sync-paths.mjs';
export { syncPaths } from '../shared/sync-paths.mjs';

const ownFile = fileURLToPath(import.meta.url);
const readJson = (file, fallback = null) => readJSON(file, fallback);
