...
export const WORKBENCH_BUILD = 'project-workbench-v22';
export const WORKBENCH_CAPABILITIES = Object.freeze([
  ...
  'journal-recovery',
  'node-managed-attachments',
  'interface-v2-device-channel',
  'project-cloud-login',
  ...
  'claude-reviewed-runtime',
  'developer-main-structure',
  'coordinator-context-streaming',
]);
