...
export const coordinatorTools = [
  definition('list_tasks', 'List project requirements plus unfinished TODO/Bug items from Main Map. executionSessionId is bound when a TODO or Bug is mounted. An empty executionSessionId means no Session is bound yet. Dispatch still waits for human approval of the brief.', {}),
