(function(global){
const { U } = global.__CG_WORKBENCH_DATA;
...
const DEMO_OPEN_BUGS = [
  ...
  { parentId:"M1", bug: demoBug("B48", "修不好", {desc:"修不好", status:"unfixable"}) },
  { parentId:"M1", bug: demoBug("B50", "手机竖屏时抽屉把手被底栏挡住，标题折成两行看点和分配会不会挤掉", {desc:"长标题", sessions:["S-live"]}) }
];

global.__CG_WORKBENCH_DATA = { U, catalog, demoSessions: DEMO_SESSION_METAS, demoBugs: DEMO_OPEN_BUGS };
})(window);
